namespace SigilBeef
{
	...
	{
		//Flags
		public const char8* nativeLibName = "sigil";
		public const char8* VER = "0.9.0";

		public const int32 SL_ALIGN_CENTER = 0;
		public const int32 SL_ALIGN_RIGHT = 1;
		public const int32 SL_ALIGN_LEFT = 2;

		public const int32 SL_KEY_ESCAPE = 256;
		public const int32 SL_KEY_ENTER = 257,
		 SL_KEY_TAB = 258,
		...
		public const int32 SL_MOUSE_BUTTON_1 = 0,
		                 SL_MOUSE_BUTTON_2 = 1,
		                 SL_MOUSE_BUTTON_3 = 2,
		                 SL_MOUSE_BUTTON_4 = 3,
		                 SL_MOUSE_BUTTON_5 = 4,
